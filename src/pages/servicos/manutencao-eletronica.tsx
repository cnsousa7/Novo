...
export default function ManutencaoEletronica() {
  return (
    <>
      <Head>
        <title>Manutenção Eletrônica em Brasília - CN Sousa TEC | Equipamentos e Sistemas</title>
        <meta
          name="description"
        ...
        <section className="bg-gradient-to-br from-purple-600 to-purple-800 text-white py-16">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <a
                href="https://wa.me/5561999999999?text=Olá! Gostaria de solicitar um orçamento para manutenção eletrônica."
                target="_blank"
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              >
                ...
                <p className="text-lg text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
                  A automação industrial é uma área em constante evolução, e a CN Sousa TEC acompanha as últimas tendências e tecnologias do setor. Prestamos serviços de manutenção em sistemas de automação baseados em CLPs (Controladores Lógicos Programáveis) de marcas como Siemens, Allen-Bradley, Schneider Electric, WEG e outras. Também trabalhamos com interfaces homem-máquina (IHM), sistemas SCADA, redes industriais e protocolos de comunicação como Profibus, Modbus e Ethernet/IP.
                </p>
